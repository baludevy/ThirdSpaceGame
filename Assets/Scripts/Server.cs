...
public class Server
{
    ...
    private void RegisterPacketHandlers()
    {
        ...
        PacketDispatch.RegisterServerHandler((ushort)ClientPacketId.DropItem, ServerHandle.DroppedItem);
    }
    ...
    public void Start(int port = 2067)
    {
        ...
        Object.Instantiate(PrefabManager.Instance.ServerGameManagerPrefab);
    }
    ...
    public void Stop()
    {
        ...
        Object.Destroy(ServerGameManager.Instance.gameObject);
    ...
    private void OnClientDisconnected(NetPeer peer, DisconnectInfo disconnectInfo)
    {
        ...
        {
            Object.Destroy(ClientGameManager.Instance.players[peer.Id].gameObject);
        }
        ...
        if (ServerGameManager.Instance.players.ContainsKey(peer.Id))
        {
            ...
            {
                Object.Destroy(ServerGameManager.Instance.players[peer.Id].gameObject);
            }
